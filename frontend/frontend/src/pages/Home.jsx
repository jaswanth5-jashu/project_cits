        ...
        <div>
            <div className="hero">
                <div className="hero-content">
                    ...
                    <div className="btns">
                        <NavLink className='btn-primary' to='/services'>Our Services
                            <span className="arrow">➜</span>
                        </NavLink>
                        <NavLink to='/career' className='btn-outline'>Explore Carreers</NavLink>
            ...
            <section className="about-section">
                <div className="about-left">
                    <div className="about-card">
                        ...
                        <h2> Akhils's Cloud Technology <br/>platform LLP</h2>
                ...
                <div className="about-right">
                    ...
                    <h1>Your Trusted<br/>Technology Partner</h1>
                    <p className="desc">
                        Akhil Cloud Platform Solutions LLP is a leading IT services company specializing
                        in cloud computing, digital transformation, and enterprise
                        software solutions. With over 15 years of experience, we've
                        helped hundreds of organizations modernize their technology
